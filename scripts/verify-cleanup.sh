...
check_item "src/index-updated.js 语法正确" "node -c src/index-updated.js 2>/dev/null"
check_item "package.json 无test命令" "! grep -q '\"test\".*test/test.js' package.json"
check_item "manifest.json 无test命令" "! grep -q '\"test\".*test/test.js' manifest.json"
